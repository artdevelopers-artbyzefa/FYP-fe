  ...
  return (
    <div className="animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="border-b border-gray-100 pb-4 mb-6">
        <h2 className="text-xl font-black text-gray-800">Academic Phase Control Center</h2>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm">
          ...
          <span className="text-sm font-bold text-gray-500">Connecting to database endpoints...</span>
        </div>
      ) : (
        <>
          {/* Active Phase Banner */}
          <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6 sm:p-8 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6" style={{ background: 'linear-gradient(135deg, #1E3A8A, #3B82F6)' }}>
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm mb-8">
            ...
            <div className="relative flex flex-col md:flex-row justify-between items-center w-full gap-6 md:gap-2">
              ...
              <div className="absolute top-7 left-8 right-8 h-1 bg-gray-100 -z-0 hidden md:block rounded-full">
                <div 
                ...
                return (
                  <div key={phase.key} className="flex md:flex-col items-center gap-3 md:gap-2 text-center md:flex-1 relative z-10 w-full md:w-auto">
                    ...
                    <div className="text-left md:text-center min-w-0">
                      <div className={`text-xs font-black truncate max-w-[200px] md:max-w-none ${isActive ? 'text-blue-600' : isPassed ? 'text-emerald-600' : 'text-gray-500'}`}>
                        {phase.name}
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {phases.map((phase) => (
              ...
              >
                ...
                {phase.isActive && (
                  <div className="absolute top-0 right-0 w-24 h-24 bg-blue-500/10 rounded-full translate-x-8 -translate-y-8 flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-inner ${
                      phase.isActive ? 'bg-blue-600' : 'bg-gray-100 text-gray-500'
                    }`}>
                  ...
                  {/* Body Content */}
                  <h4 className="text-base font-black text-gray-900 mb-2 leading-tight">
                    {phase.name}
                  </h4>
                ...
                <div className="pt-4 border-t border-gray-50 flex items-center justify-between">
                  ...
                  {phase.isActive ? (
                    <span className="flex items-center gap-1.5 text-xs font-black text-blue-600">
                    ...
                    <button 
                      ...
                      className="px-4 py-2 bg-gray-50 hover:bg-blue-600 text-gray-600 hover:text-white border border-gray-200 hover:border-blue-600 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-sm hover:shadow cursor-pointer"
                    >
