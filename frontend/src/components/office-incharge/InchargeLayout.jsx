...
const LayoutInner = () => {
  ...
  const navLinks = [
    ...
    { to: '/office-incharge/phase2-marks', icon: BarChart3, label: 'Phase 2 (30%) Marks', section: 'Overview' },
    { to: '/office-incharge/final-marks', icon: ClipboardList, label: 'Final Calculated Marks', section: 'Overview' },
