...
export default function AdminLayout() {
  ...
  const navItems = [
    { id: '/admin-dashboard',           label: 'Dashboard',             icon: 'fa-server',      section: 'System' },
    { id: '/admin-dashboard/users',       label: 'User Accounts',         icon: 'fa-user-cog',    section: 'Account & RBAC' },
    { id: '/admin-dashboard/rbac',        label: 'Role Checklists',       icon: 'fa-user-shield', section: null },
    { id: '/admin-dashboard/audit',       label: 'System Audit Logs',     icon: 'fa-history',     section: 'Security & Maintenance' },
    { id: '/admin-dashboard/maintenance', label: 'System Maintenance',    icon: 'fa-tools',       section: null },
  ];
