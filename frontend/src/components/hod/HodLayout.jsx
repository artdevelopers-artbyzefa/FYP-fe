        ...
        <div className="bg-white border-b border-blue-100 px-4 md:px-6 h-16 flex items-center justify-between shadow-sm flex-shrink-0 z-[30] gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-base font-black text-slate-900 leading-tight truncate">Executive Portal</h2>
              ...
              {showNotif && (
                <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-blue-100 overflow-hidden z-[100] animate-in fade-in-50 duration-200">
                  <div className="p-4 bg-white border-b border-blue-100 flex items-center justify-between">
                    <span className="text-sm font-black text-slate-900">HOD Notifications</span>
                  ...
                  <div className="max-h-80 overflow-y-auto divide-y divide-blue-600">
                    <div className="p-4 hover:bg-white/50 transition-colors flex gap-3 items-start border-l-4 border-primary bg-white/10">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-xs font-bold text-slate-900">Grievance Escalation Alert</div>
                        <div className="text-[11px] text-slate-600 mt-0.5">FYP Office In-charge escalated Grievance #GRV-089 (Evaluation Dispute) for HOD binding decision.</div>
                        <div className="text-[10px] text-slate-500 mt-1 font-bold">30 mins ago</div>
                      </div>
                    </div>
                  </div>
                  <div className="p-3 bg-white border-t border-blue-100 text-center">
                    <button onClick={() => navigate('/hod/escalations')} className="text-xs font-bold text-slate-600 hover:text-primary transition-colors cursor-pointer">View All</button>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="relative">
              <button className="flex items-center gap-2 p-1 md:px-2.5 md:py-1.5 bg-white rounded-xl cursor-pointer border border-blue-100 hover:bg-blue-50 hover:border-primary transition-all">
                ...
                <div className="text-left hidden sm:block">
                  <div className="text-xs font-bold text-slate-900 leading-tight truncate max-w-28">{user.name || 'Prof. Dr. Zafar Ali'}</div>
                  <div className="text-[10px] text-slate-500 leading-tight font-bold">HOD CS</div>
                </div>
              </button>
            </div>
          </div>
