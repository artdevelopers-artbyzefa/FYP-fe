    ...
    <div className="flex h-screen overflow-hidden" style={{ fontFamily: "'Poppins', sans-serif", backgroundColor: '#EFF6FF' }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        ...
        <header className="bg-white border-b border-line px-4 md:px-6 h-16 flex items-center justify-between shadow-card flex-shrink-0 z-30 gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <button onClick={() => setSidebarCollapsed(p => !p)} className="hidden lg:flex w-9 h-9 rounded-xl bg-white items-center justify-center text-slate-900 hover:bg-white transition-all border-0 flex-shrink-0 cursor-pointer">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-line overflow-hidden z-[100]">
                  ...
                  <div className="max-h-72 overflow-y-auto divide-slate-50">
                    {notifications.length === 0 ? (
                      <p className="p-8 text-center text-xs text-slate-900 font-bold">No new notifications</p>
                    ) : notifications.map(n => (
                      <div key={n.id} className={`p-4 hover:bg-blue-50/50 transition-colors flex gap-3 items-start border-l-4 ${n.read ? 'border-transparent' : 'border-line'}`}>
            ...
            <div className="flex items-center gap-2 p-1 md:px-2.5 md:py-1.5 bg-white rounded-xl cursor-pointer border border-line hover:bg-white hover:border-blue-600 transition-all">
              ...
              <div className="text-left hidden sm:block">
                ...
                <div className="text-[10px] text-slate-900 leading-tight font-bold">SysAdmin</div>
              </div>
            </div>
          </div>
        </header>
            ...
            {activeView === 'dashboard' && (
              <div className="animate-in fade-in slide-in- duration-300">
                ...
                <div className="rounded-[2rem] p-6 sm:p-8 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-card border border-line"
                  ...
                  <button onClick={() => goTo('users')} className="bg-white hover:bg-white text-white px-5 py-3 rounded-xl font-bold text-sm shadow-lg transition-all flex items-center gap-2 cursor-pointer border border-line">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                  <div className="bg-white rounded-2xl border border-line p-6 shadow-card flex items-center gap-5 hover:border-blue-600 transition-all">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-bold text-slate-900 tracking-wider mb-1 truncate">Registered Users</div>
                  ...
                  <div className="bg-white rounded-2xl border border-line p-6 shadow-card flex items-center gap-5 hover:border-blue-600 transition-all">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-bold text-slate-900 tracking-wider mb-1 truncate">Active Roles</div>
                  ...
                  <div className="bg-white rounded-2xl border border-line p-6 shadow-card flex items-center gap-5 hover:border-blue-600 transition-all">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-bold text-slate-900 tracking-wider mb-1 truncate">Audit Entries</div>
                  ...
                  <div className="bg-white rounded-2xl border border-line p-6 shadow-card flex items-center gap-5 hover:border-blue-600 transition-all">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-bold text-slate-900 tracking-wider mb-1 truncate">System Health</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div onClick={() => goTo('users')} className="bg-white p-6 rounded-2xl border border-line shadow-card hover:border-blue-600 hover:shadow-md transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none group">
                    ...
                    <h3 className="font-bold text-slate-900 text-base mb-1">User Accounts</h3><p className="text-xs text-slate-900 font-medium">Create credentials, manage profiles, trigger resets.</p>
                  </div>
                  <div onClick={() => goTo('rbac')} className="bg-white p-6 rounded-2xl border border-line shadow-card hover:border-blue-600 hover:shadow-md transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none group">
                    <div className="flex justify-between items-center mb-4">
                    ...
                    <h3 className="font-bold text-slate-900 text-base mb-1">Role Checklists</h3><p className="text-xs text-slate-900 font-medium">Configure RBAC permissions.</p>
                  </div>
                  <div onClick={() => goTo('audit')} className="bg-white p-6 rounded-2xl border border-line shadow-card hover:border-blue-600 hover:shadow-md transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none group">
                    <div className="flex justify-between items-center mb-4">
                    ...
                    <h3 className="font-bold text-slate-900 text-base mb-1">Audit Logs</h3><p className="text-xs text-slate-900 font-medium">System-wide event logging.</p>
                  </div>
                  <div onClick={() => goTo('maintenance')} className="bg-white p-6 rounded-2xl border border-line shadow-card hover:border-blue-600 hover:shadow-md transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none group">
                    <div className="flex justify-between items-center mb-4">
                    ...
                    <h3 className="font-bold text-slate-900 text-base mb-1">Maintenance</h3><p className="text-xs text-slate-900 font-medium">Database backups, cache clearing.</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="animate-in fade-in slide-in- duration-300">
                ...
                <div className="bg-white rounded-2xl border border-line p-4 mb-6 shadow-card flex flex-col sm:flex-row gap-4 items-center justify-between">
                  <div className="relative w-full sm:w-80">
                    ...
                    <input type="text" value={searchUser} onChange={e => setSearchUser(e.target.value)} placeholder="Search user name or email..." className="w-full pl-10 pr-4 py-2.5 bg-white border border-line rounded-xl text-sm outline-none focus:border-line focus:bg-white transition-all" />
                  </div>
                  <select value={roleFilter} onChange={e => setRoleFilter(e.target.value)} className="bg-white border border-line rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 outline-none focus:border-line cursor-pointer w-full sm:w-auto">
                      ...
                      <tbody className="divide-slate-50 text-xs font-medium text-slate-900">
                        {filteredUsers.map(u => (
                          <tr key={u.id} className="hover:bg-blue-50/30 transition-colors">
                            ...
                            <td className="py-4 px-6 text-slate-900 font-mono">{u.email}</td>
                            <td className="py-4 px-6"><span className="bg-white text-slate-900 font-bold px-2.5 py-1 rounded-lg border border-line">{u.role}</span></td>
                            <td className="py-4 px-6 text-center"><span className="bg-white text-slate-900 font-bold px-2.5 py-1 rounded-lg border border-line">{u.status}</span></td>
                            <td className="py-4 px-6 text-right space-x-1">
                              <button onClick={() => handleResetPassword(u)} className="px-2.5 py-1 rounded-lg bg-white hover:bg-white text-slate-900 border border-line font-bold transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none">Reset</button>
                              <button onClick={() => handleToggleStatus(u)} className="px-2.5 py-1 rounded-lg bg-white hover:bg-white text-slate-900 border border-line font-bold transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none">Deactivate</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
            ...
            {activeView === 'audit' && (
              <div className="animate-in fade-in slide-in- duration-300">
                <div className="border-b border-line pb-4 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <button onClick={() => toast.success('Audit logs export started.')} className="px-5 py-2.5 bg-white border border-line text-slate-900 hover:bg-white rounded-xl text-xs font-bold shadow-card transition-all flex items-center gap-2 cursor-pointer">
      ...
      {createUserOpen && (
        <div className="fixed inset-0 bg-blue-600/50 backdrop-blur-sm z-[150] flex items-center justify-center p-4">
          <div className="bg-white rounded-[2rem] w-full max-w-lg p-6 sm:p-8 shadow-2xl animate-in zoom-in-95 duration-200 border border-line">
            <div className="flex justify-between items-center mb-6 pb-3 border-b border-line">
              <h3 className="text-lg font-black text-slate-900">Create New User Account</h3>
            ...
            <form onSubmit={handleCreateUserSubmit} className="space-y-5">
              <div>
                ...
                <input name="name" type="text" placeholder="e.g. Dr. Bilal Ahmed" className="w-full bg-white border border-line rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 outline-none focus:border-line transition-all" required />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-900 mb-1.5">Email Address</label>
                <input name="email" type="email" placeholder="e.g. bilal@cuiatd.edu.pk" className="w-full bg-white border border-line rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 outline-none focus:border-line transition-all" required />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-900 mb-1.5">Assign Primary System Role</label>
                <select name="role" className="w-full bg-white border border-line rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 outline-none focus:border-line cursor-pointer" required>
                  <option value="Faculty Supervisor">Faculty Supervisor</option>
                  <option value="FYP Office Assistant">FYP Office Assistant</option>
                  <option value="FYP Office In-charge">FYP Office In-charge</option>
                  <option value="HOD">HOD</option>
