...
const InchargeDashboard = () => {
  ...
  useEffect(() => {
    getInchargeDashboardStats().then(res => setStats(res.data)).catch(console.error);
  }, []);
    ...
    <>
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6 sm:p-8 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 animate-[fadeIn_0.4s_ease-out]" style={{ background: 'linear-gradient(135deg, #2B3990, #1E3A8A)' }}>
        ...
        <div className="flex gap-3 flex-wrap">
          <button onClick={() => navigate('/office-incharge/supervision-requests')} className="bg-white text-primary hover:bg-gray-50 px-5 py-3 rounded-xl font-bold text-sm shadow-lg transition-all flex items-center gap-2 cursor-pointer">
            <i className="fas fa-user-plus"></i> Pending Requests ({stats ? stats.pendingSupervisionReqs : 0})
          </button>
          <button onClick={() => navigate('/office-incharge/grievances')} className="bg-amber-500 hover:bg-amber-600 text-white px-5 py-3 rounded-xl font-bold text-sm shadow-lg transition-all flex items-center gap-2 cursor-pointer">
            <i className="fas fa-balance-scale"></i> Grievances ({stats ? stats.openGrievances : 0})
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex items-center gap-5 hover:border-blue-200 transition-all">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-3xl font-black text-gray-800">{stats ? stats.activeRubrics : '...'}</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex items-center gap-5 hover:border-blue-200 transition-all">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-3xl font-black text-gray-800">{stats ? stats.pendingSupervisionReqs : '...'}</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex items-center gap-5 hover:border-blue-200 transition-all">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-3xl font-black text-gray-800">{stats ? stats.openGrievances : '...'}</span>
              <span className="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-lg">{stats ? stats.slaBreaches : 0} SLA Breach</span>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex items-center gap-5 hover:border-blue-200 transition-all">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-3xl font-black text-gray-800">{stats ? stats.activeSession : '...'}</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div onClick={() => navigate('/office-incharge/rubrics')} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-secondary hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
        ...
        <div onClick={() => navigate('/office-incharge/sessions')} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-secondary hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-4">
        ...
        <div onClick={() => navigate('/office-incharge/committee-oversight')} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-secondary hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-4">
        ...
        <div onClick={() => navigate('/office-incharge/grievances')} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-secondary hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-4">
