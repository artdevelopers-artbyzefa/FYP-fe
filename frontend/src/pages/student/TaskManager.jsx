    ...
    <div className="bg-white rounded-[16px] p-5 shadow-sm border border-black/80 hover:shadow-md hover:border-blue-600 transition-all cursor-pointer">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[12px] font-bold text-black">{task.date}</span>
          {task.overdue && (
      ...
      {task.progress !== undefined && (
        <div className="mb-4">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[12px] font-semibold text-black">Progress</span>
      ...
      <div className="flex items-center justify-between mt-1 pt-2 border-t border-black">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="w-[30px] h-[30px] rounded-[8px] bg-[#eff6ff] text-[#2563eb] flex items-center justify-center hover:bg-white transition-colors"
          >
...
const TaskManager = () => {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 min-h-screen bg-[#f4f7fe] font-poppins antialiased">
      ...
      {fetchError && (
        <div className="mx-6 mt-4 flex items-center gap-3 bg-white border border-black text-black px-5 py-3.5 rounded-2xl text-[13px] font-semibold shadow-sm">
          <svg className="w-4 h-4 shrink-0 text-black" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="p-6 md:p-8 max-w-[1400px] w-full mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            {/* Tabs */}
            <div className="hidden md:flex items-center gap-1 bg-white px-1.5 py-1.5 rounded-2xl shadow-sm border border-black overflow-x-auto">
              {tabs.map(tab => (
                <button
                  key={tab.id}
          ...
          <div className="flex items-center gap-3 relative">
            ...
            <button
              ...
              className="w-10 h-10 rounded-xl bg-white border border-black shadow-sm flex items-center justify-center text-black relative hover:bg-white transition-colors cursor-pointer"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 top-[52px] w-80 bg-white rounded-[24px] border border-black shadow-xl py-4 z-50 animate-in fade-in slide-in- duration-200">
                <div className="px-4 pb-3 border-b border-black flex items-center justify-between">
                  <span className="text-[13px] font-extrabold text-black tracking-tight">Notifications</span>
                  {notifications.filter(n => n.unread).length > 0 && (
                    <button
                ...
                <div className="max-h-[280px] overflow-y-auto">
                  {notifications.map((n) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] text-black font-semibold block mt-1 pl-1.5">{n.time}</span>
                    </div>
                  ))}
                </div>
                <div className="px-4 pt-3 border-t border-black text-center">
                  <span className="text-[11px] font-extrabold text-black hover:underline cursor-pointer">
        ...
        {activeTab === 'Task Board' ? (
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              <div className="relative w-full sm:w-[280px]">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-white border border-black/80 rounded-xl text-[14px] font-medium text-black focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-black transition-all shadow-sm placeholder:text-black"
                />
              </div>

              <div className="relative">
                <select className="appearance-none bg-white border border-black/80 rounded-xl pl-4 pr-10 py-2.5 text-[14px] font-semibold text-black focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-black transition-all shadow-sm cursor-pointer min-w-[150px]">
                  <option>All Priorities</option>
                  <option>High</option>
                  <option>Medium</option>
                  <option>Low</option>
                </select>
                <ChevronDown className="w-4 h-4 absolute right-3.5 top-1/2 -translate-y-1/2 text-black pointer-events-none" />
              </div>
          ...
          <div className="space-y-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="mt-8 flex items-center gap-6">
                      ...
                      <div className="flex flex-col justify-end w-full max-w-[320px] min-w-[240px] mb-1">
                        ...
                        <span className="text-[12px] text-black/70 font-medium mt-2">5 of 20 tasks completed</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-8 lg:mr-16 w-full lg:w-auto">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[12px] text-black font-semibold mt-1">Active</span>
                  </div>
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[12px] text-black font-semibold mt-1">Review</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <ClipboardList className="w-6 h-6 text-white mb-2" />
                    <span className="text-[26px] font-black leading-none">7</span>
                    <span className="text-[12px] text-black font-semibold mt-1">Pending</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-[20px] p-6 shadow-sm border border-black flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-black mb-1">Total Tasks</span>
                  <span className="text-[32px] font-black text-[#1e293b] leading-none mb-2">20</span>
                  <span className="text-[12px] font-medium text-black">All tasks in project</span>
                </div>
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-sm border border-black flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-black mb-1">Completed</span>
                  <span className="text-[32px] font-black text-[#16a34a] leading-none mb-2">5</span>
                  <span className="text-[12px] font-medium text-black">25% completion rate</span>
                </div>
                <div className="w-[52px] h-[52px] rounded-[14px] bg-white flex items-center justify-center">
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-sm border border-black flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-black mb-1">In Progress</span>
                  <span className="text-[32px] font-black text-[#2563eb] leading-none mb-2">5</span>
                  <span className="text-[12px] font-medium text-black">Currently active</span>
                </div>
                <div className="w-[52px] h-[52px] rounded-[14px] bg-white flex items-center justify-center">
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-sm border border-black flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-black mb-1">Pending</span>
                  <span className="text-[32px] font-black text-[#ea580c] leading-none mb-2">7</span>
                  <span className="text-[12px] font-medium text-black">3 in review</span>
                </div>
                <div className="w-[52px] h-[52px] rounded-[14px] bg-white flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={idx} className="bg-white rounded-[16px] p-5 shadow-sm border border-black flex items-center justify-between group hover:border-[#2563eb]/30 transition-colors cursor-pointer relative overflow-hidden">
                      ...
                      <div className="flex flex-col gap-1.5 ml-1">
                        ...
                        {(task.priority || task.assignee) && (
                          <div className="flex items-center gap-3">
                            ...
                            {task.assignee && (
                              <span className="text-[13px] font-semibold text-black flex items-center gap-1.5">
              ...
              <div className="bg-white rounded-[24px] p-8 shadow-sm border border-black lg:h-max">
                  ...
                  <div className="space-y-8 relative z-10">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col mt-1">
                        ...
                        <span className="text-[12px] font-semibold text-black mt-1">2 h ago</span>
                      </div>
                    </div>

                    <div className="flex items-start gap-4">
                      <div className="w-10 h-10 rounded-full bg-white text-white flex items-center justify-center font-bold text-[13px] shrink-0 border-4 border-white shadow-sm ring-1 ring-gray-100">
                        FK
                      </div>
                      <div className="flex flex-col mt-1">
                        <p className="text-[14px] text-black font-medium leading-relaxed">
                        ...
                        <span className="text-[12px] font-semibold text-black mt-1">3 h ago</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col mt-1">
                        ...
                        <span className="text-[12px] font-semibold text-black mt-1">4 h ago</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex flex-col mt-1">
                        ...
                        <span className="text-[12px] font-semibold text-black mt-1">5 h ago</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={idx} className="bg-white border border-black rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all group">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-[12px] text-black font-semibold mt-0.5">{member.role}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-[12px] font-bold text-black">Productivity</span>
            ...
            <div className="bg-white border border-black rounded-[24px] p-6 shadow-sm">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-[#1e3a8a] text-white flex items-center justify-center text-[16px] font-bold shrink-0 shadow-sm border border-black/10">
                  TH
                </div>
                <div className="flex flex-col">
                  <h4 className="text-[16px] font-bold text-[#1e293b] leading-tight">Dr. Tariq Hassan</h4>
                  <p className="text-[13px] text-black font-semibold mt-0.5">
                    Associate Professor <span className="text-black mx-1.5">•</span> Department of Computer Science
                  </p>
                  <p className="text-[13px] text-black font-semibold mt-0.5">
                    tariq.hassan@cuiatd.edu.pk <span className="text-black mx-1.5">•</span> Office Hours: Mon/Wed 2-4 PM
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-6 pb-6 bg-white/50 mt-2">
            ...
            <div className="bg-white border border-black rounded-[24px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col items-center">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 w-full">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2.5 px-3 py-2 bg-white border border-black rounded-xl">
                    <span className={`w-3 h-3 rounded-full ${item.color} shrink-0`}></span>
                    <div className="flex flex-col">
                      <span className="text-[12px] font-extrabold text-black leading-tight">{item.label}</span>
                      <span className="text-[10px] font-bold text-black mt-0.5">{item.count} tasks</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="lg:col-span-2 bg-white border border-black rounded-[24px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-bold text-black">Assigned</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-3.5 h-3.5 rounded bg-[#1e3a8a]"></span>
                    <span className="text-[12px] font-bold text-black">Completed</span>
                  </div>
                </div>
              </div>
                    ...
                    <Tooltip 
                      ...
                      content={({ active, payload }) => {
                        if (active && payload && payload.length) {
                          return (
                            <div className="bg-white text-white text-[11px] font-bold px-3 py-2 rounded-xl shadow-lg border border-black/50 flex flex-col gap-1">
                              <p className="text-black font-extrabold text-[12px] mb-0.5">{payload[0].payload.name}</p>
          ...
          <div className="bg-white border border-black rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)] mt-2 mx-6 mb-6">
            <div className="flex items-center gap-2 mb-6 text-black font-bold text-base">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {[
                ...
                return (
                  <div key={idx} className="bg-[#fef2f2] border-l-4 border-black rounded-r-xl px-4 py-3 flex items-center justify-between shadow-[0_2px_8px_rgba(0,0,0,0.01)] w-full group hover:shadow-sm transition-all duration-200">
                    <div className="flex items-center">
                      {/* Left Date Block */}
                      <div className="bg-white/50 w-12 h-12 rounded-xl flex flex-col items-center justify-center shrink-0 mr-3.5">
                        <span className="text-black font-bold text-base leading-none">{deadline.day}</span>
                        <span className="text-black text-[10px] font-bold uppercase mt-0.5">{deadline.month}</span>
                      </div>
                    ...
                    {/* Right Overdue Tag */}
                    <span className="bg-white/60 text-black text-[10px] font-extrabold px-3 py-1 rounded-full border border-black/50 tracking-wider shrink-0 uppercase">
                      OVERDUE
                    </span>
                  </div>
                );
          ...
          <div className="px-6 pb-6 bg-white/50 space-y-8 mt-2">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={supervisor.id}
                  className="bg-white border border-black rounded-[24px] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:-translate-y-0.5 group"
                >
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 bg-white text-black rounded-2xl flex items-center justify-center text-[18px] font-bold border border-black/50 shrink-0">
                      {supervisor.avatar}
                    </div>
                    <div className="flex flex-col">
                      <h3 className="text-[18px] font-bold text-[#1e293b] tracking-tight">{supervisor.name}</h3>
                      <p className="text-[13px] text-black font-medium">{supervisor.designation}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button className="w-[52px] h-[52px] border border-black rounded-xl flex items-center justify-center text-black hover:bg-white transition-all cursor-pointer">
      ...
      {showAddTaskModal && (
        <div className="fixed inset-0 bg-white/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <form
            ...
            className="bg-white rounded-[28px] max-w-md w-full p-6 border border-black shadow-2xl relative flex flex-col gap-5 animate-in slide-in- duration-300"
          >
            <div className="flex items-center justify-between">
              <h3 className="text-[18px] font-black text-black tracking-tight flex items-center gap-2">
                <Plus className="w-5 h-5 text-black" /> Create New Task
              </h3>
              <button
                type="button"
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-black rounded-xl text-sm placeholder:text-black focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-black transition-all font-medium text-black"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-black rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-black transition-all font-semibold text-black cursor-pointer"
                  >
            ...
            <div className="flex items-center gap-3 mt-4">
              <button
                type="button"
                onClick={() => setShowAddTaskModal(false)}
                className="flex-1 py-3 bg-white text-black rounded-xl font-bold text-xs hover:bg-white transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-black rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-black transition-all font-medium text-black"
                />
              </div>
