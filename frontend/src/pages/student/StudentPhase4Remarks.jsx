...
import { getStudentPhase4Remarks } from '../../services/phase4.service';
...
const StudentPhase4Remarks = () => {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    getStudentPhase4Remarks()
      .then(res => setData(res.data || null))
      .catch(() => setError('Failed to load Phase 4 remarks.'))
    ...
    return (
      <div className="space-y-6">
        ...
        <EmptyState
          ...
          message="Phase 4 evaluation remarks have not been published yet. Check back after your supervisor and committee have submitted their evaluations."
        />
      </div>
    );
  }
...
const Header = () => (
  <div className="border-b border-line pb-4">
    <h2 className="text-xl font-bold text-slate-900">Phase 4 Evaluation Remarks</h2>
    <p className="text-xs text-slate-500 mt-0.5 font-medium">Feedback from your supervisor and evaluation committee on your Phase 4 work.</p>
  </div>
);
...
export default StudentPhase4Remarks;
