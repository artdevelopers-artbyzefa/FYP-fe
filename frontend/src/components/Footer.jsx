        ...
        <footer className="py-12 border-t border-black bg-white">
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 flex flex-wrap items-center justify-between gap-8">
                ...
                <div className="flex flex-wrap gap-4 sm:gap-6">
                    <a href="#" className="text-[13px] font-bold text-black no-underline transition-colors hover:text-black">Privacy Policy</a>
                    <a href="#" className="text-[13px] font-bold text-black no-underline transition-colors hover:text-black">Terms of Service</a>
                    <a href="#" className="text-[13px] font-bold text-black no-underline transition-colors hover:text-black">Accessibility</a>
                </div>
