        ...
        <div className="bg-white border-b border-gray-100 px-3 md:px-6 h-14 md:h-16 flex items-center justify-between shadow-sm flex-shrink-0 z-[30] gap-3">
          <div className="flex items-center gap-2 md:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-sm md:text-base font-bold text-primary leading-tight truncate">FYP Office Portal</h2>
                ...
                <div className="absolute right-0 top-11 bg-white border border-gray-100 rounded-2xl w-80 shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
                  ...
                  <div className="max-h-[350px] overflow-y-auto">
                    <div className="flex items-start gap-3 px-4 py-3.5 border-b border-gray-50 last:border-0 hover:bg-gray-50/80 cursor-pointer transition-colors bg-blue-50/30">
                      <div className="w-8 h-8 rounded-xl bg-amber-50 text-amber-500 flex items-center justify-center flex-shrink-0 mt-0.5"><Megaphone className="text-xs" /></div>
                      <div className="min-w-0 flex-1">
                        <p className="text-xs font-bold text-gray-900">Proposal Decisions Published</p>
                        <p className="text-[10px] text-gray-400 mt-0.5 line-clamp-2">PEC-1 has published decisions for 14 pending proposals.</p>
                        <p className="text-[9px] text-gray-300 font-bold mt-1.5">10 mins ago</p>
                      </div>
                    </div>
                  </div>
                </div>
