...
import { getStudentPhase2Remarks } from '../../services/phase2.service';
...
const StudentPhase2Remarks = () => {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    getStudentPhase2Remarks()
      .then(res => setData(res.data || null))
      .catch(() => setError('Failed to load Phase 2 remarks.'))
    ...
    return (
      <div className="space-y-6">
        ...
        <EmptyState
          ...
          message="Phase 2 evaluation remarks have not been published yet. Check back after your supervisor and committee have submitted their evaluations."
        />
      </div>
    );
  }
...
const Header = () => (
  <div className="border-b border-line pb-4">
    <h2 className="text-xl font-bold text-slate-900">Phase 2 Evaluation Remarks</h2>
    <p className="text-xs text-slate-500 mt-0.5 font-medium">Feedback from your supervisor and evaluation committee on your Phase 2 work.</p>
  </div>
);
...
export default StudentPhase2Remarks;
