...
const Hero = ({ title, subtitle, badge, ctaText, ctaLink, secondaryCta, features }) => {
  ...
  return (
    <section className="relative overflow-hidden bg-lightbg py-16 lg:py-24">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="font-display font-extrabold text-4xl md:text-5xl lg:text-6xl text-primary leading-tight tracking-tight mb-5">
              {title}
            </h1>
          ...
          {/* Right Feature Card */}
          {features && (
            <div className="flex-1 max-w-md w-full bg-white rounded-2xl p-6 lg:p-8 shadow-xl border border-blue-50 animate-fade-up">
              {features.map((feature, idx) => (
                <div key={idx} className={`flex gap-4 ${idx !== 0 ? 'mt-6 pt-6 border-t border-blue-50' : ''}`}>
