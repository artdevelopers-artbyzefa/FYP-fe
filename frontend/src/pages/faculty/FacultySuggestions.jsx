...
import { Lightbulb, Users, Loader2, Check, X, Clock, Plus, BookOpen, Code, Layers, ChevronDown } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-blue-600/50 backdrop-blur-sm z-[150] flex items-center justify-center p-4">
          <div className="bg-white rounded-[2rem] w-full max-w-2xl p-6 sm:p-8 shadow-2xl border border-line max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6 pb-3 border-b border-line">
              <div>
                <h3 className="text-lg font-bold text-slate-900">Suggest New Project Idea</h3>
                <p className="text-xs text-slate-400 mt-0.5">Propose a project idea to one of your supervised groups</p>
              </div>
              <button onClick={() => setShowForm(false)} className="w-8 h-8 rounded-xl bg-gray-50 border border-line flex items-center justify-center text-slate-400 hover:bg-gray-100 transition-all cursor-pointer">
                <X size={16} />
              </button>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-line rounded-xl pl-10 pr-4 py-2.5 text-sm outline-none focus:border-blue-500 transition-all"
                    />
                  </div>
                </div>
              </div>
