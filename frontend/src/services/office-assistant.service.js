...
export const getOfficeDashboardStats = async () => {
  // return await apiClient.get(OFFICE_DASHBOARD_API_URL);
...
export const getOfficeUsers = async () => {
  // return await apiClient.get(OFFICE_USERS_API_URL);
...
export const getOfficeStudents = async () => {
  // return await apiClient.get(OFFICE_STUDENTS_API_URL);
...
export const getOfficeFaculty = async () => {
  // return await apiClient.get(OFFICE_FACULTY_API_URL);
...
export const getOfficeProjects = async () => {
  // return await apiClient.get(OFFICE_PROJECTS_API_URL);
...
export const getOfficeContent = async () => {
  // return await apiClient.get(OFFICE_CONTENT_API_URL);
...
export const getOfficeExternal = async () => {
  // return await apiClient.get(OFFICE_EXTERNAL_API_URL);
...
export const getOfficeResults = async () => {
  // return await apiClient.get(OFFICE_RESULTS_API_URL);
