  ...
  return (
    <div className="animate-in fade-in slide-in- duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div onClick={() => navigate('/admin-dashboard/users')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group">
        ...
        <div onClick={() => navigate('/admin-dashboard/rbac')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group">
          <div className="flex justify-between items-center mb-4">
        ...
        <div onClick={() => navigate('/admin-dashboard/audit')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group">
          <div className="flex justify-between items-center mb-4">
        ...
        <div onClick={() => navigate('/admin-dashboard/maintenance')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group">
          <div className="flex justify-between items-center mb-4">
