  ...
  return (
    <div className="animate-[fadeIn_0.4s_ease-out]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div onClick={() => navigate('/incharge/rubrics')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
        ...
        <div onClick={() => navigate('/incharge/sessions')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-4">
        ...
        <div onClick={() => navigate('/incharge/committee-oversight')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-4">
        ...
        <div onClick={() => navigate('/incharge/grievances')} className="bg-white p-6 rounded-2xl border border-black shadow-sm hover:border-black hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-4">
