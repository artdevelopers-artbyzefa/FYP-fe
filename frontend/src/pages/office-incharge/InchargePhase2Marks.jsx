...
import { getPhase2Marks } from '../../services/phase2.service';
import { FileText, Printer, Search, Loader2 } from 'lucide-react';

const InchargePhase2Marks = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-line pb-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Phase 2 (30%) Marks</h2>
          <p className="text-xs text-slate-500 mt-0.5 font-medium">Supervisor and committee marks with calculated totals.</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-line shadow-sm overflow-hidden" id="printArea">
        <div className="hidden print:block p-6 text-center border-b border-line">
          ...
          <h2 className="text-sm font-bold text-slate-700 mt-1">FYP Phase 2 (30%) Evaluation — Spring 2026</h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
...
export default InchargePhase2Marks;
